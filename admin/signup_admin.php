...
<head>
<title>Sign &raquo; School Management and Information System</title>
<meta charset="iso-8859-1">
<link rel="icon" href='../images/deped_logo_old.jpg'/>
<link rel='stylesheet' type='text/css' href='../bootstrap/css/bootstrap.css' media="screen"/>
<link rel="stylesheet" href="css/signup_admin.css" type="text/css">
...
<div class="wrapper row1">
  <header id="header" class="clear">
    <hgroup>
      <h2 class='sys-title-abb'><a href="../index.php" >School Management and Information System</a></h2>
    </hgroup>
    <!--nav>
      <ul>
        <li><a href="#">DropDown</a><span></li>
          <ul>
        ...
        <li class="active"><a href="contact_us.php">Full Width</a><span>Test Text Here</span></li>
        <li><a href="style-demo.html">Style Demo</a><span>Test Text Here</span></li>
        <li><a href="index.php">Home</a><span>Test Text Here</span></li>
      </ul>
    </nav-->
  </header>
</div>
